    ...
    const wordForm = (
        <Fragment>
            ...
            <form onSubmit={onWordSubmit}>
                <input autoCapitalize="none" id="spanish" type="text" placeholder="Spanish" name="spanish" value={spanish} onChange={onWordChange} />
                <input autoCapitalize="none" type="text" placeholder="English" name="english" value={english} onChange={onWordChange} />
